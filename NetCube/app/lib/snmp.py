    ...
    try:
        errorIndication, errorStatus, errorIndex, varBinds = next(
            getCmd(SnmpEngine(),
                ...
                ObjectType(ObjectIdentity('1.3.6.1.2.1.2.2.1.2.8')),#Adaptador de red
                ...
                ObjectType(ObjectIdentity('1.3.6.1.2.1.31.1.1.1.15.24')),#Mbps/Ethernet
                ObjectType(ObjectIdentity('1.3.6.1.2.1.31.1.1.1.15.10'))#Mbps/wifi
                )
        )

        if errorIndication:
            print(">"+"No se ha recibido respuesta SNMP del host")
        ...
        print(">"+"Error al acceder al host",hostip)
        return
